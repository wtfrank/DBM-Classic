...
DBM = {
	...
	DisplayVersion = "1.13.25 alpha", -- the string that is shown as version
	...
	for i = 1, 2 do
		if GetBattlefieldStatus(i) == "confirm" then
			if self.Options.ShowQueuePop and not self.Options.DontShowBossTimers then
				...
				fireEvent("DBM_TimerStart", "DBMBFSTimer", queuedBattlefield[i], expiration or 85, UnitFactionGroup("player") == "Alliance" and "132486" or "132485", "extratimer", nil, 0)
			end
