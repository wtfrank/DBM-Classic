...
DBM = {
	...
	DisplayVersion = "1.13.4", -- the string that is shown as version
	ReleaseRevision = releaseDate(2019, 8, 31) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
