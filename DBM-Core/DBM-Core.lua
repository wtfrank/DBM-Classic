...
DBM = {
	...
	DisplayVersion = "1.13.12 alpha", -- the string that is shown as version
	ReleaseRevision = releaseDate(2019, 9, 21, 12) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
