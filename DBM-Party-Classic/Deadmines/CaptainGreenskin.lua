local mod	= DBM:NewMod("CaptainGreenskin", "DBM-Party-Classic", 3)
...
local timerPoisonedHarpoonCD		= mod:NewAITimer(5208, 6304, nil, "RemovePoison", nil, 5, nil, DBM_CORE_POISON_ICON)
